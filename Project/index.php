...
<head>
    ...
    <title>Index - Agrolog Bootstrap Template</title>
    <meta name="description" content="Sustainable agriculture solutions for modern farming needs.">
    <meta name="keywords" content="agriculture, farming, organic, vegetables, sustainable">

    <!-- Favicons -->
    <link href="Assets/Templates/Main/assets/img/favicon.png" rel="icon">
    ...
    <header id="header" class="header d-flex align-items-center position-relative">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.php" class="logo d-flex align-items-center">
                ...
                <img src="Assets/Templates/Main/assets/img/logo.png" alt="Agrolog">
                <!-- <h1 class="sitename">Agrolog</h1>  -->
            </a>
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li><a href="Guest/StudentRegistration.php">User Registration</a></li>
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            ...
            <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel"
                ...
                <div class="carousel-item active">
                    <img src="Assets/Templates/Main/assets/img/hero_1.jpg" alt="">
                    <div class="carousel-container">
                        <h2>Sustainable Farming for a Greener Tomorrow</h2>
                        <p>Empowering farmers with innovative agriculture solutions to combat food scarcity and promote eco-friendly practices.</p>
                    </div>
                </div><!-- End Carousel Item -->

                <div class="carousel-item">
                    <img src="Assets/Templates/Main/assets/img/hero_2.jpg" alt="">
                    <div class="carousel-container">
                        <h2>Organic Produce for Healthier Lives</h2>
                        <p>Growing chemical-free vegetables that nourish the body and protect the environment.</p>
                    </div>
                </div><!-- End Carousel Item -->

                <div class="carousel-item">
                    <img src="Assets/Templates/Main/assets/img/hero_3.jpg" alt="">
                    <div class="carousel-container">
                        <h2>Fresh Harvests Delivered Daily</h2>
                        <p>From soil to table, ensuring nutrient-rich produce reaches communities sustainably.</p>
                    </div>
                </div><!-- End Carousel Item -->

                <div class="carousel-item">
                    <img src="Assets/Templates/Main/assets/img/hero_4.jpg" alt="">
                    <div class="carousel-container">
                        <h2>Passion-Driven Agriculture</h2>
                        <p>Dedicated to advancing farming techniques that support biodiversity and long-term soil health.</p>
                    </div>
                </div><!-- End Carousel Item -->

                <div class="carousel-item">
                    <img src="Assets/Templates/Main/assets/img/hero_5.jpg" alt="">
                    <div class="carousel-container">
                        <h2>Nourishing the World Sustainably</h2>
                        <p>Committed to agriculture that feeds generations while preserving our planet's resources.</p>
                    </div>
                </div><!-- End Carousel Item -->
        ...
        <section id="services" class="services section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Our Agriculture Services</h2>
                <p>Comprehensive solutions for modern farming, from planting to harvest.</p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>Expert seed planting and crop establishment using sustainable methods.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>Soil conservation through organic mulching to retain moisture and suppress weeds.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>Efficient land preparation with eco-friendly plowing techniques for optimal soil aeration.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>Precision mowing for field maintenance and cover crop management.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>Advanced seeding technologies for high-yield crop germination.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>Premium, farm-fresh vegetables grown organically for quality assurance.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>Efficient irrigation systems for water conservation in crop cultivation.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <p>Direct-to-consumer sales of seasonal, locally-sourced vegetables.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <img src="Assets/Templates/Main/assets/img/img_long_5.jpg" alt="Sustainable Farming"
                                class="img-fluid img-overlap" data-aos="zoom-out">
                        </div>
                        <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
                            <h3 class="content-subtitle text-white opacity-50">Why Choose Agrolog</h3>
                            <h2 class="content-title mb-4">
                                Over <strong>50 Years</strong> of Expertise in Sustainable Agriculture
                            </h2>
                            <p class="opacity-50">
                                We specialize in eco-friendly farming practices that enhance soil health, reduce water usage, and promote biodiversity for long-term agricultural success.
                            </p>
                            ...
                            <div class="row my-5">
                                <div class="col-lg-12 d-flex align-items-start mb-4">
                                    ...
                                    <div>
                                        <h4 class="m-0 h5 text-white">Efficient Water Management</h4>
                                        <p class="text-white opacity-50">Drip irrigation systems to optimize rainfall and conserve resources.</p>
                                    </div>
                                </div>
                                <div class="col-lg-12 d-flex align-items-start mb-4">
                                    <i class="bi bi-heart me-4 display-6"></i>
                                    <div>
                                        <h4 class="m-0 h5 text-white">Organic Farming Focus</h4>
                                        <p class="text-white opacity-50">Chemical-free methods for nutrient-rich, healthy produce.</p>
                                    </div>
                                </div>
                                <div class="col-lg-12 d-flex align-items-start">
                                    <i class="bi bi-shop me-4 display-6"></i>
                                    <div>
                                        <h4 class="m-0 h5 text-white">Farm-to-Market Supply</h4>
                                        <p class="text-white opacity-50">Fresh, traceable vegetables delivered directly to your table.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="content">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <h3>Subscribe for Agriculture Updates</h3>
                            <p class="opacity-50">
                                Stay informed on sustainable farming tips, seasonal harvests, and industry innovations.
                            </p>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6 footer-about">
                        <a href="index.html" class="logo d-flex align-items-center">
                            <span class="sitename">Agrolog</span>
                        </a>
                        <div class="footer-contact pt-3">
                            <p>A108 Adam Street</p>
                            <p>New York, NY 535022</p>
                            <p class="mt-3"><strong>Phone:</strong> <span>+1 5589 55488 55</span></p>
                            <p><strong>Email:</strong> <span>info@agrolog.com</span></p>
                        </div>
                    </div>
        ...
        <div class="copyright text-center">
            <div
                ...
                <div class="d-flex flex-column align-items-center align-items-lg-start">
                    <div>
                        © Copyright <strong><span>Agrolog</span></strong>. All Rights Reserved
                    </div>
                    <div class="credits">
